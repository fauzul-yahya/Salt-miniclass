...
import { AtIcon, dockerIcon, facebookIcon, fauzul, flutterIcon, githubIcon, imageOne, imageThree, imageTwo, linkedinIcon, mongodbIcon, reactIcon, twitterIcon, typescriptIcon } from '../assets/images'

const MainPage = () => {
  return (
    <>
      <section id='welcome'>
        <img width='300px' height='300px' src={fauzul} />
        <h2>Fauzul Yahya</h2>
